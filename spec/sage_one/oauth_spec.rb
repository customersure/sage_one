...
describe SageOne::OAuth do
  ...
  describe 'get_access_token' do
    it 'returns an object containing an access_token' do
      ...
      stub_post("https://accounts.sageone.com/oauth/token/").
    ...
    describe 'failure cases' do
      context 'invalid client' do
        before do
          ...
          stub_post("https://accounts.sageone.com/oauth/token/").to_return(status: 401, body: fixture('oauth/invalid_client.json'))
        end
      ...
      context 'wrong code' do
        before { stub_post("https://accounts.sageone.com/oauth/token/").to_return(status: 400, body: fixture('oauth/invalid_grant.json')) }
      ...
      context 'wrong callback' do
        before { stub_post("https://accounts.sageone.com/oauth/token/").to_return(status: 401, body: '') }
